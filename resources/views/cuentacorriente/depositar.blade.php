                ...
                <div class="card-body">
                  <form action="{!! route('cuentacorriente.store') !!}" method="post">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="monto" type="number" min="0" step=".01" class="form-control{{ $errors->has('monto') || $errors->first('saldo')  ? ' is-invalid' : '' }}" name="monto" value="{{ old('monto') }}" required autofocus>
